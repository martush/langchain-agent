...
Initial Flow:  question -> supervisor picks ONE specialist -> that specialist answers -> 
...
Updated flow - plan and execute - split question into subtasks since supervisor does not reliably call the second tool
